...
button2=Button(tab1,text="Summarize",command=get_summary, width=12,bg='#66ff66',fg='#fff')
button2.grid(row=4,column=1,padx=10,pady=10)

button3=Button(tab1,text="Clear Result", command=clear_display_result,width=12,bg='#03A9F4',fg='#fff')
button3.grid(row=5,column=0,padx=10,pady=10)

button4=Button(tab1,text="Close", width=12,command=window.destroy,bg='#ff1a1a',fg='#fff')
...
b1=Button(tab2,text="Reset ", width=12,command=clear_text_file,bg="#03A9F4")
b1.grid(row=3,column=1,padx=10,pady=10)

b2=Button(tab2,text="Summarize", width=12,command=get_file_summary,bg='#66ff66',fg='#fff')
...
b4=Button(tab2,text="Close", width=12,command=window.destroy,bg='#ff1a1a',fg='#fff')
...
button2=Button(tab3,text="Get Text",command=get_text, width=12,bg='#c5cae9',fg='#fff')
button2.grid(row=4,column=1,padx=10,pady=10)

button3=Button(tab3,text="Clear Result", command=clear_url_display,width=12,bg='#03A9F4',fg='#fff')
button3.grid(row=5,column=0,padx=10,pady=10)

button4=Button(tab3,text="Summarize",command=get_url_summary, width=12,bg='#66ff66',fg='#fff')
button4.grid(row=5,column=1,padx=10,pady=10)

button5=Button(tab3,text="Close", width=12,command=window.destroy,bg='#ff1a1a',fg='#fff')
